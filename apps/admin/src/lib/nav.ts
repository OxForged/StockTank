...
export const ADMIN_NAV: readonly (AdminNavItem | AdminNavGroup)[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Advertisers', to: '/advertising/advertisers', milestone: 11 },
      { label: 'Campaigns', to: '/advertising/campaigns', milestone: 11 },
      { label: 'Placements', to: '/advertising/placements', icon: Wallet, milestone: 11 },
    ],
  },
  {
    label: 'System',
    ...
    items: [
      ...
      { label: 'Feature flags', to: '/system/feature-flags', icon: Flag, permission: 'feature_flags.manage', milestone: 6, description: 'Toggle unfinished features per environment.' },
